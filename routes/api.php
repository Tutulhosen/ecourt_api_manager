...
use App\Http\Controllers\AppsApi\CitizenAppsApiController;
use App\Http\Controllers\EmcMobileApiController;
...
Route::post('gcclogin', [LoginController::class, 'gcc_court_api_login'])->name('gcclogin.mc');
Route::post('emclogin', [LoginController::class, 'emc_court_api_login'])->name('emclogin.mc');
Route::post('citizen_login', [LoginController::class, 'citizen_login'])->name('citizen_login.mc');

//citizen registation process
Route::post('citizen_registration', [CitizenAppsApiController::class, 'citizen_registration'])->name('citizen.registration');
Route::post('citizen_registration_opt_verify', [CitizenAppsApiController::class, 'citizen_registration_opt_verify'])->name('citizen.registration.otp.verify');
Route::post('registration_otp_resend', [CitizenAppsApiController::class, 'registration_otp_resend'])->name('citizen.registration.otp.resent');
Route::post('password_set_for_citizen', [CitizenAppsApiController::class, 'password_set_for_citizen'])->name('password.set.for.citizen');
Route::post('password_set_for_org', [CitizenAppsApiController::class, 'password_set_for_org'])->name('password.set.for.org');
Route::post('getDependentOrganization', [CitizenAppsApiController::class, 'getDependentOrganization'])->name('get.dependent.organization');

Route::post('deleteCitizen', [CitizenAppsApiController::class, 'deleteCitizen'])->name('deleteCitizen');
...
Route::middleware(['auth:api', 'auth.api'])->prefix('v1')->group(function () {
    ...
    Route::post('certify/copy/payment/data', [GccCitizenAppealController::class, 'certify_copy_payment_data']);
...
Route::get('/dashboard_emc', [EmcMobileApiController::class, 'dashboard_emc'])->name('dashboard_emc.emc');
Route::get('/cause_list_emc', [EmcMobileApiController::class, 'cause_list_emc'])->name('cause_list_emc.emc');
Route::get('/dashboard_causelist_emc', [EmcMobileApiController::class, 'dashboard_causelist_emc'])->name('dashboard_causelist_emc.emc');
Route::get('/division_emc', [EmcMobileApiController::class, 'division_emc'])->name('division_emc.emc');
Route::get('/district_emc/{id}', [EmcMobileApiController::class, 'district_emc'])->name('district_emc.emc');
Route::get('/upazila_emc/{id}', [EmcMobileApiController::class, 'upazila_emc'])->name('upazila_emc.emc');
Route::get('/court_emc/{id}', [EmcMobileApiController::class, 'court_emc'])->name('court_emc.emc');
Route::get('/profile_emc/{id}', [EmcMobileApiController::class, 'profile_emc'])->name('profile_emc.emc');
Route::get('/tracking_emc/{id}', [EmcMobileApiController::class, 'tracking_emc'])->name('tracking_emc.emc');
Route::get('/crpc_emc', [EmcMobileApiController::class, 'crpc_emc'])->name('crpc_emc.emc');
Route::get('/case_details_emc/{id}', [EmcMobileApiController::class, 'case_details_emc'])->name('case_details_emc.emc');
Route::get('/caseList_emc', [EmcMobileApiController::class, 'caseList_emc'])->name('caseList_emc.emc');
Route::get('/caseNothi_emc', [EmcMobileApiController::class, 'caseNothi_emc'])->name('caseNothi_emc.emc');
Route::get('/case_hearing_check_emc/{id}', [EmcMobileApiController::class, 'case_hearing_check_emc'])->name('case_hearing_check_emc.emc');
Route::get('/court_execute_emc', [EmcMobileApiController::class, 'court_execute_emc'])->name('court_execute_emc.emc');

//citizen  route
Route::get('emc_citizen_appeal_create', [CitizenAppsApiController::class, 'emc_citizen_appeal_create'])->name('emc.citizen.appeal.create');
Route::get('citizen_dashboard', [CitizenAppsApiController::class, 'citizen_dashboard'])->name('citizen.dashboard');
Route::get('citizen_dashboard_data_for_gcc', [CitizenAppsApiController::class, 'citizen_dashboard_data_for_gcc'])->name('citizen.dashboard.data.for.gcc');

//citizen case list
Route::get('case_for_emc_citizen', [CitizenAppsApiController::class, 'case_for_emc_citizen'])->name('case.for.emc.citizen');
Route::get('case_for_gcc_citizen', [CitizenAppsApiController::class, 'case_for_gcc_citizen'])->name('case.for.gcc.citizen');
Route::get('case_for_gcc_org_rep', [CitizenAppsApiController::class, 'case_for_gcc_org_rep'])->name('case.for.gcc.org.rep');

//citizen case details
Route::get('case_details_for_emc_citizen', [CitizenAppsApiController::class, 'case_details_for_emc_citizen'])->name('case.details.for.emc.citizen');
Route::get('case_details_for_gcc_citizen', [CitizenAppsApiController::class, 'case_details_for_gcc_citizen'])->name('case.details.for.gcc.citizen');
Route::get('case_details_for_gcc_org_rep', [CitizenAppsApiController::class, 'case_details_for_gcc_org_rep'])->name('case.details.for.gcc.org.rep');

//citizen case Tracking
Route::get('case_tracking_for_emc_citizen', [CitizenAppsApiController::class, 'case_tracking_for_emc_citizen'])->name('case.tracking.for.emc.citizen');
Route::get('case_tracking_for_gcc_citizen', [CitizenAppsApiController::class, 'case_tracking_for_gcc_citizen'])->name('case.tracking.for.gcc.citizen');
Route::get('case_tracking_for_gcc_org_rep', [CitizenAppsApiController::class, 'case_tracking_for_gcc_org_rep'])->name('case.tracking.for.gcc.org.rep');
